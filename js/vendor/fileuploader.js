...
qq.FileUploaderBasic = function (o) {
    this._options = {
        ...
        messages:{
            ...
            minSizeError:"{file} имеет слишком маленький размер, минимальный размер файла: {minSizeLimit}.",
            emptyError:"{file} пуст (имеет нулевой размер), пожалуйста, выберите другой файл.",
            onLeave:"При закрытии окна загрузка фотографий будет прервана."
        },
...
qq.FileUploader = function (o) {
    ...
    qq.extend(this._options, {
        ...
        listElement:null,
        dragText:'Перетащите фотографии сюда',
        ...
        fileTemplate:'<li class="uploadedFotoVisualItem">' +
