...
/**********************************************************************************
 * ВЫБОР ВАРИАНТА СОРТИРОВКИ РЕЗУЛЬТАТОВ ВЫДАЧИ
 **********************************************************************************/

$('#typeOfSortingSelect').on("change", function () {
    // Получаем выбранное значение для сортировки
    var typeOfSorting = $("#typeOfSortingSelect option:selected").val();
    // Меняем скрытый инпут со значением типа сортировки для отправки вместе с остальными параметрами в качестве поискового запроса
    $("#typeOfSorting").val(typeOfSorting);
    // Обновляем страницу с результатами поиска
