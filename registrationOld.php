...
<head>
    ...
    <style>
        ...
        .step-error {
            ...
            color: #FFF !important;
            -moz-box-shadow: 1px 1px 4px #C6C4C4 -webkit-box-shadow: 1px 1px 4px #C6C4C4 box-shadow: 1px 1px 4px #C6C4C4
        }

        .step-success {
            background: #72e487 !important;
            color: #FFF !important;
            -moz-box-shadow: 1px 1px 1px 4px #C6C4C4 -webkit-box-shadow: 1px 1px 1px 4px #C6C4C4 box-shadow: 1px 1px 1px 4px #C6C4C4
        }
    </style>
...
<div class="form-step">
    ...
    <div class="row">
        ...
        <div class="form-right"><input type="text" name="surname" id="surname" size="33" class="form-input"
                                       autofocus <?php echo "value='$surname'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
        <div class="form-left">Имя *</div>
        <div class="form-right"><input type="text" name="name" id="name" size="33"
                                       class="form-input" <?php echo "value='$name'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
        <div class="form-left">Отчество *</div>
        <div class="form-right"><input type="text" name="secondName" id="secondName" size="33"
                                       class="form-input" <?php echo "value='$secondName'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="form-right"><input type="text" name="birthday" id="birthday" size="33" class="form-input"
                                       placeholder="дд.мм.гггг" <?php echo "value='$birthday'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
        <div class="form-left"></div>
    ...
    <div class="row">
        ...
        <div class="form-right"><input type="text" name="login" id="login" size="33" class="form-input" maxlength="50"
                                       placeholder="номер телефона или e-mail" <?php echo "value='$login'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
        <div class="form-left">Пароль *</div>
        <div class="form-right"><input type="password" name="password" id="password" size="33" class="form-input"
                                       maxlength="50" <?php echo "value='$password'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
        <div class="form-left"></div>
    ...
    <div class="row">
        ...
        <div class="form-right"><input type="text" name="telephon" id="telephon" size="33" class="form-input"
                                       maxlength="10" <?php echo "value='$telephon'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
        <div class="form-left">E-mail *</div>
        <div class="form-right"><input type="text" name="email" id="email" size="33"
                                       class="form-input" <?php echo "value='$email'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
...
<div class="form-step">
    ...
    <div class="row ifLearned"
        ...
        <div class="form-right"><input type="text" name="almamater" id="almamater" size="33"
                                       class="form-input ifLearned" <?php echo "value='$almamater'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row ifLearned">
        <div class="form-left">Специальность *</div>
        <div class="form-right"><input type="text" name="speciality" id="speciality" size="33"
                                       class="form-input ifLearned" <?php echo "value='$speciality'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row ifLearned" title="Укажите курс, на котором учитесь">
        <div class="form-left">Курс *</div>
        <div class="form-right"><input type="text" name="kurs" id="kurs" size="33"
                                       class="form-input ifLearned" <?php echo "value='$kurs'";?>/></div>
        <div class="form-error"></div>
    </div>
    ...
    <div class="row ifLearned" title="Укажите год окончания учебного заведения">
        ...
        <div class="form-right"><input type="text" name="yearOfEnd" id="yearOfEnd" size="33"
                                       class="form-input ifLearned" <?php echo "value='$yearOfEnd'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
        <div class="form-left"></div>
    ...
    <div class="row ifWorked">
        ...
        <div class="form-right"><input type="text" name="placeOfWork" id="placeOfWork" size="33"
                                       class="form-input ifWorked" <?php echo "value='$placeOfWork'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row ifWorked">
        <div class="form-left">Должность *</div>
        <div class="form-right"><input type="text" name="workPosition" id="workPosition" size="33"
                                       class="form-input ifWorked" <?php echo "value='$workPosition'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
        <div class="form-left"></div>
    ...
    <div class="row">
        ...
        <div class="form-right"><input type="text" name="regionOfBorn" id="regionOfBorn" size="33"
                                       class="form-input" <?php echo "value='$regionOfBorn'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
        <div class="form-left">Родной город, населенный пункт *</div>
        <div class="form-right"><input type="text" name="cityOfBorn" id="cityOfBorn" size="33"
                                       class="form-input" <?php echo "value='$cityOfBorn'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row">
        <div class="form-left">Коротко о себе и своих интересах *</div>
        <div class="form-right"><textarea name="shortlyAboutMe" id="shortlyAboutMe" cols="33"
                                          rows="4"><?php echo $shortlyAboutMe;?></textarea></div>
        <div class="form-error"></div>
    </div>
</div>
...
<div class="form-step">
    <div class="row"
        ...
        <div class="form-right" style="height: 35px; line-height: 35px; padding: 5px;"><input type="text"
                                                                                              name="vkontakte"
                                                                                              id="vkontakte" size="100"
                                                                                              class="form-input"
    ...
    <div class="row"
        ...
        <div class="form-right" style="height: 35px; line-height: 35px; padding: 5px;"><input type="text" name="twitter"
                                                                                              id="twitter" size="100"
                                                                                              class="form-input"
...
<div class="form-step">
    ...
    <div class="row"
        ...
        <div class="form-right"><input type="text" name="minCost" id="minCost" size="33" class="form-input"
                                       maxlength="8" <?php echo "value='$minCost'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row"
         title="Укажите, сколько Вы готовы платить в месяц за аренду недвижимости с учетом стоимости коммунальных услуг (если они оплачиваются дополнительно)">
        <div class="form-left">Арендная плата до, руб.</div>
        <div class="form-right"><input type="text" name="maxCost" id="maxCost" size="33" class="form-input"
                                       maxlength="8" <?php echo "value='$maxCost'";?>/></div>
        <div class="form-error"></div>
    </div>
    <div class="row" title="Какую сумму Вы готовы передать собственнику в качестве возвращаемого гарантийного депозита">
        ...
        <div class="form-right"><input type="text" name="pledge" id="pledge" size="33" class="form-input"
                                       maxlength="8" <?php echo "value='$pledge'";?>/></div>
        <div class="form-error"></div>
    </div>
    ...
    <div class="row" id="withWhoDescription" style="display: none;">
        ...
        <div class="form-right">
            <textarea name="linksToFriends" id="linksToFriends" cols="33"
    ...
    <div class="row" id="childrenDescription" style="display: none;">
        ...
        <div class="form-right">
            <textarea name="howManyChildren" id="howManyChildren" cols="33"
    ...
    <div class="row" id="animalsDescription" style="display: none;">
        ...
        <div class="form-right">
            <textarea name="howManyAnimals" id="howManyAnimals" cols="33"
    ...
    <div class="row">
        ...
        <div class="form-right">
            <textarea name="additionalDescriptionOfSearch" id="additionalDescriptionOfSearch" cols="33"
                      rows="3"><?php echo $additionalDescriptionOfSearch;?></textarea>
        </div>
        <div class="form-error"></div>
    </div>
</div>
