...
class Property
{
	...
	public function unpublishAdvert() {
		...
		if (!$this->saveCharacteristicToDB("edit")) return array("Не удалось снять с публикации объявление: ошибка доступа к базе. Попробуйте повторить немного позже или свяжитесь с нами по телефону 89221431615");
	...
	public function publishAdvert() {
		...
		// Валидация начальных данных
		if ($this->id == "" || $this->status == "" || $this->completeness == "") return array("Не удалось опубликовать объявление: недостаточно данных. Попробуйте повторить немного позже или обратитесь к нам: 89221431615");
		...
		if (!$this->saveCharacteristicToDB("edit")) return array("Не удалось опубликовать объявление: ошибка при записи данных в базу. Попробуйте повторить немного позже или обратитесь к нам: 89221431615");
