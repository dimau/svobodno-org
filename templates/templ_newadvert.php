...
<form name="newAdvert" class="advertDescriptionEdit formWithFotos" method="post" enctype="multipart/form-data"
      action="newadvert.php?action=saveAdvert<?php if ($isAdmin['newAdvertAlien'] && $alienOwner == "true") echo "&alienOwner=true";?>">
<div class="advertDescriptionChapter" id="typeAndPeriodChapter">
    ...
    <div class="objectDescriptionItem">
        <div class="objectDescriptionItemLabel">
            Статус опубликованности (если выбрать "опубликовать", то будет произведена рассылка о новом объекте по
            арендаторам):
        </div>
        <div class="objectDescriptionBody">
...
<div class="advertDescriptionChapter" id="specialConditions">
    ...
    <div class="objectDescriptionItem"
        ...
        <div class="objectDescriptionBody" style="min-width: 330px">
            <textarea name="responsibility" maxlength="2000" rows="7"
                      cols="43"><?php echo $propertyCharacteristic['responsibility'];?></textarea>
        </div>
    </div>
    <div class="objectDescriptionItem">
        <div class="objectDescriptionItemLabel">
