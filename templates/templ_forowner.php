...
<div class="pageWithoutFooter">
    ...
    <div class="mainContentBlock"
        ...
        <ul class="simpleTextList">
            <li>
                В течение дня Вам перезвонит оператор и подробно зафиксирует параметры недвижимости
            </li>
            <li>
                Оператор также попросит выслать фотографии недвижимости на электронную почту (но это не обязательно)
            </li>
            <li>
                Как только объявление будет сформировано, мы его опубликуем на портале Svobodno.org
            </li>
            <li>
                Арендаторы с условиями поиска, подходящими под Вашу недвижимость, автоматически получат sms и e-mail уведомления. Они смогут связаться с Вами
            </li>
            <li>
                Анкеты арендаторов, которые заинтересуются Вашей недвижимостью, станут доступны для просмотра в
                Вашем личном кабинете. Это позволит принять более взвешенное решение о том, кого из претендентов Вы хотите видеть в качестве арендатора
            </li>
            <li>
