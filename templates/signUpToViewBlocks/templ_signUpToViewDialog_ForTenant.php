<form method="post" name="signUpToViewDialog" id="signUpToViewDialog" action="property.php?action=signUpToView<?php echo "&propertyId=".$propertyCharacteristic['id'];?>" title="Записаться на просмотр">
