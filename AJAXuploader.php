...
class qqFileUploader {
    ...
    function handleUpload($uploadDirectory, $replaceOldFile = FALSE) {
        ...
        return array('success' => TRUE, 'folder' => $saveRes['folder'], // Папка, в которой сохранена фотография, вида: "uploaded_files/6"
    ...
    function saveImg($foto_dst, $uploadDirectory, $type, $filename) {
        ...
        if (imagejpeg($foto_dst, $urlForSave, 85)) {
            ...
            return array('folder' => $uploadDirectory . $subDirectory, 'ext' => "jpeg");
    ...
    function saveInfToDB($folder, $filename, $size) {
        ...
        $res = DBconnect::insertPhotoForFileUploadId(array('id' => $filename, 'fileUploadId' => $_GET['fileuploadid'], 'folder' => $folder, 'filename' => $_GET['sourcefilename'], 'extension' => $extension, 'filesizeMb' => $sizeMb, 'regDate' => $regDate));
