...
$cheap = time() - (5 * 24 * 60 * 60); // 5 дней для объявлений дешевле 29 000 рублей
$medium = time() - (10 * 24 * 60 * 60); // 10 дней для объявлений от 29 000 - 49 000 рублей
$expensive = time() - (16 * 24 * 60 * 60); // 16 дней для объявлений от 49 000 рублей и выше
