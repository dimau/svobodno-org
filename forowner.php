				...
				<div class="wrapperOfTabs">
					...
					<div id="tabs">
                        ...
                        <div id="tabs-2">
                            ...
                            <p id="text1">
                                Похож на сценарий работы обычных агентств недвижимости: собственник не платит за наши услуги, но и не получает денежный бонус. Комиссия взимается с арендатора в размере 30% после заключения договора аренды. Взаимодействует с потенциальными арендаторами и приводит их на показ недвижимости к собственнику сотрудник Хани Хом.
                            </p>
                            <p>
                                <a href="#" id="tarif2">2. "Улучшенный"</a>
                            </p>
                            <p id="text2">
                                В этом случае, в отличие от предыдущего сценария, мы берем в самом начале работы с собственника фиксированную комиссию (1100 руб.). После чего собственник вправе назначить собственную комиссию для арендатора от 0 до 30% от месячной стоимости аренды недвижимости, которая позволит не только покрыть расходы собственника на поиск арендатора, но и получить денежный бонус. Важно, что при этом сценарии работы наши сотрудники не участвуют в показах недвижимости арендаторам, а собственник получает возможность просматривать подробные анкеты каждого заинтересовавшегося его недвижимостью потенциального арендатора в своем личном кабинете на сайте Хани Хом.
                            </p>
                            <p>
                                <a href="#" id="tarif3">3. "Идеальный"</a>
                            </p>
                            <p id="text3">
                                Не применяется при первой сдаче объекта недвижимости в аренду, так как первоначально его должен осмотреть специалист Хани Хом для того, чтобы гарантировать арендаторам полноту и достоверность сведений. Отличается своей простотой и максимальной эффективностью: чтобы сдать свою недвижимость во второй и последующие разы собственнику достаточно зайти в личный кабинет на сайте Хани Хом и нажать на кнопку "Опубликовать". При этом нужно будет оплатить комиссию в размере 550 руб. В остальном схема работы идентична варианту "улучшенный".
                            </p>
                        </div>
						<div id="tabs-3">
							<p>
