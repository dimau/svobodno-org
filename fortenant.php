						...
						<div id="tabs-1">
							<p>
								...
								<ul>
									...
									<li>
										<p>
											Максимально подробные и честные сведения о себе, которые Вы укажете на портале, позволят избежать лишних выездов и просмотров тех объектов, чьи собственники выставляют к арендаторам особенные требования (например: без животных, без детей, женатые пары...).
										</p>
										<p>
