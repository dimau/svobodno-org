...
// Если в запросе не указан идентификатор объекта недвижимости или полученный массив новых значений пуст, то отказываем в доступе
if ($propertyId == "" || $propertyId == 0 || count($newValueArr) == 0 || $action == "") {
	GlobFunc::accessDenied();
}
