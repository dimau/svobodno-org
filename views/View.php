...
class View
{
	...
	public static function getHTMLforFavorites($propertyId, $favoritePropertiesId, $typeOfHTML) {
		...
		if (!isset($propertyId) ||
			//!is_int($propertyId) ||
			!isset($favoritePropertiesId) ||
			!is_array($favoritePropertiesId) ||
			($typeOfHTML != "stringWithIcon" && $typeOfHTML != "onlyIcon")
		) return "";
	...
	public static function getFullBalloonHTML($oneProperty, $favoritePropertiesId = array()) {
		...
		// Площади помещений
		$arrBalloonReplace['areaValuesName'] = "Площадь (";
		...
		if (isset($oneProperty['typeOfObject']) && $oneProperty['typeOfObject'] != "квартира" && $oneProperty['typeOfObject'] != "дом" && $oneProperty['typeOfObject'] != "таунхаус" && $oneProperty['typeOfObject'] != "дача" && $oneProperty['typeOfObject'] != "гараж" && $oneProperty['roomSpace'] != "") {
			$arrBalloonReplace['areaValuesName'] .= "комнаты";
		...
		if (isset($oneProperty['typeOfObject']) && $oneProperty['typeOfObject'] != "комната" && $oneProperty['totalArea'] != "") {
			$arrBalloonReplace['areaValuesName'] .= "общая";
		...
		if (isset($oneProperty['typeOfObject']) && $oneProperty['typeOfObject'] != "комната" && $oneProperty['typeOfObject'] != "гараж" && $oneProperty['livingSpace'] != "") {
			$arrBalloonReplace['areaValuesName'] .= "/жилая";
		...
		if (isset($oneProperty['typeOfObject']) && $oneProperty['typeOfObject'] != "дача" && $oneProperty['typeOfObject'] != "гараж" && $oneProperty['kitchenSpace'] != "") {
			$arrBalloonReplace['areaValuesName'] .= "/кухни";
			$arrBalloonReplace['areaValues'] .= " / " . $oneProperty['kitchenSpace'];
		}
		if ($arrBalloonReplace['areaValuesName'] == "Площадь (") {
			$arrBalloonReplace['areaValuesName'] = "";
		} else {
			$arrBalloonReplace['areaValuesName'] .= "):";
	...
	public static function getFullParametersListItemHTML($oneProperty, $favoritePropertiesId = array(), $number) {
		...
		// Избранное
		$arrExtendedListReplace['favorites'] = "";
		...
		if (isset($oneProperty['typeOfObject']) && $oneProperty['typeOfObject'] != "квартира" && $oneProperty['typeOfObject'] != "дом" && $oneProperty['typeOfObject'] != "таунхаус" && $oneProperty['typeOfObject'] != "дача" && $oneProperty['typeOfObject'] != "гараж" && $oneProperty['roomSpace'] != "" && $oneProperty['roomSpace'] != "") {
			$arrExtendedListReplace['areaValues'] .= "<span title='площадь комнаты'>" . $oneProperty['roomSpace'] . " м²</span><br>";
		}
		if (isset($oneProperty['typeOfObject']) && $oneProperty['typeOfObject'] != "комната" && $oneProperty['totalArea'] != "" && $oneProperty['totalArea'] != "") {
			$arrExtendedListReplace['areaValues'] .= "<span title='общая площадь'>" . $oneProperty['totalArea'] . " м²</span><br>";
		}
		if (isset($oneProperty['typeOfObject']) && $oneProperty['typeOfObject'] != "комната" && $oneProperty['typeOfObject'] != "гараж" && $oneProperty['livingSpace'] != "" && $oneProperty['livingSpace'] != "") {
			$arrExtendedListReplace['areaValues'] .= "<span title='жилая площадь'>" . $oneProperty['livingSpace'] . " м²</span><br>";
		}
		if (isset($oneProperty['typeOfObject']) && $oneProperty['typeOfObject'] != "дача" && $oneProperty['typeOfObject'] != "гараж" && $oneProperty['kitchenSpace'] != "" && $oneProperty['kitchenSpace'] != "") {
		...
		// Инициализируем массив с строками, которые будут использоваться для подстановки в шаблоне баллуна
		$arrExtendedListTemplVar = array('{propertyId}', '{number}', '{favorites}', '{fotosWrapper}', '{typeOfObject}', '{district}', '{address}', '{amountOfRooms}', '{adjacentRooms}', '{areaValues}', '{floor}', '{furniture}', '{costOfRenting}', '{utilities}');
		// Копируем html-текст шаблона блока (строки таблицы)
